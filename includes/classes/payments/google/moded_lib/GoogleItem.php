 ...
 */
  ...
  */
  class GoogleItem {
     ...
     * @return void
     */
    function SetEmailDigitalDelivery($email_delivery='false',$display_disposition = 'PESSIMISTIC') {
      $this->digital_url = '';
      $this->digital_key = '';
      $this->digital_description = '';
      $this->email_delivery = $email_delivery;
      $this->display_disposition = $display_disposition;
     ...
     * @return void
     */
    function SetURLDigitalContent($digital_url, $digital_key, $digital_description, $display_disposition = 'PESSIMISTIC') {
