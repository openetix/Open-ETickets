...
//   UseCase3();
  ...
  function Usecase() {
      ...
      $merchant_id = "327632073270495";  // Your Merchant ID
      $merchant_key = "ovtT8z-WOBhfPAsfhftltQ";  // Your Merchant Key
      $server_type = "sandbox";
      $currency = "GBP";
      ...
      $dataArr = array('order-id'=>23);
      
      $mpd = new MerchantPrivateData($dataArr);
